...
Item {
    ...
    property real fadeSize: Colors.m3colors.darkmode ? 40 : 20
    property color color: ColorUtils.transparentize(Colors.colors.colShadow, Colors.m3colors.darkmode ? 0 : 0.7)
