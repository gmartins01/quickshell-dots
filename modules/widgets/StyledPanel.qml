...
Loader {
    ...
    sourceComponent: Component {
        PanelWindow {
            ...
            Behavior on color {
                ColorAnimation {
                    duration: 200//Style.animationNormal
                }
            }
            ...
            Rectangle {
                ...
                width: {
                    ...
                    return Math.min(w, screen?.width - 5 * 2);
                }
                height: {
                    var h;
                    ...
                    // Clamp width so it is never bigger than the screen
                    return Math.min(h, screen?.height - Appearance.sizes.barHeight * scaling - 5/*Style.margii*/ * 2);
                }
                ...
                //     switch (barPosition) {
                //     case "top":
                //         return 5//(Style.barHeight + Style.marginS) * scaling + (Settings.data.bar.floating ? Settings.data.bar.marginVertical * Style.marginXL * scaling : 0);
                //     // default:
                ...
                //     switch (barPosition) {
                //     case "left":
                //         return 5//(Style.barHeight + Style.marginS) * scaling + (Settings.data.bar.floating ? Settings.data.bar.marginHorizontal * Style.marginXL * scaling : 0);
                //     // default:
                //     //     return Style.marginS * scaling;
                //     }
                // }
                ...
                Rectangle {
                    ...
                    border.color: Colors.m3colors.m3primary
                    border.width: Math.max(2, 6 * scaling)
                    ...
                    Rectangle {
                        ...
                        color: "transparent"//Color.transparent
                        border.color: Colors.m3colors.m3primary
                        border.width: Math.max(1, 5 * scaling)
                        radius: parent.radius
                        opacity: 0.3
                    }
                }
