...
RadioButton {
    ...
    property color activeColor: Colors?.colors.colPrimary ?? "#685496"
    property color inactiveColor: Colors?.m3colors.m3onSurfaceVariant ?? "#45464F"
    ...
    contentItem: RowLayout {
        ...
        Rectangle {
            ...
            Rectangle {
                ...
                height: checked ? 10 : 4
                radius: Appearance?.rounding.full
                color: Colors?.colors.colPrimary
                opacity: checked ? 1 : 0
