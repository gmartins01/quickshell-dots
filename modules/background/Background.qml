// from https://github.com/noctalia-dev/noctalia-shell/blob/main/Modules/Background/Background.qml
...
Variants {
    ...
    delegate: Loader {
        ...
        active: Settings.ready && modelData && Settings.options.wallpaper.enabled//Settings.isLoaded && modelData //&& Settings.data.wallpaper.enabled
        ...
        sourceComponent: PanelWindow {
            ...
            property vector4d fillColor: Qt.vector4d(Settings.options.wallpaper.fillColor.r, Settings.options.wallpaper.fillColor.g, Settings.options.wallpaper.fillColor.b, 1.0)
            ...
            NumberAnimation {
                ...
                duration: transitionType == "stripes" ? Settings.options.wallpaper.transitionDuration * 1.6 : Settings.options.wallpaper.transitionDuration
            ...
            function changeWallpaper() {
                ...
                transitionType = Settings.options.wallpaper.transitionType;
