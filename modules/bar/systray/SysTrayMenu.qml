    ...
    MouseArea {
        ...
        Rectangle {
            ...
            anchors {
                left: parent.left
                right: parent.right
                verticalCenter: Settings.options.bar.vertical ? parent.verticalCenter : undefined //TODO: VER ISTO
                top: Settings.options.bar.vertical ? undefined : Settings.options.bar.bottom ? undefined : parent.top
                bottom: Settings.options.bar.vertical ? undefined : Settings.options.bar.bottom ? parent.bottom : undefined
