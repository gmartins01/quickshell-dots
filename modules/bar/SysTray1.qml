...
Item {
    ...
    property list<var> itemsNotInUserList: SystemTray.items.values.filter(i => (!Settings.options.bar.tray.pinnedItems.includes(i.id) && i.status !== Status.Passive))
    property bool invertPins: Settings.options.bar.tray.invertPinnedItems
    ...
    GridLayout {
        ...
        RippleButton {
            ...
            contentItem: MaterialIcon {
                ...
                color: root.trayOverflowOpen ? Colors.colors.colOnSecondaryContainer : Colors.colors.colOnLayer2
