...
RippleButton { // Expand button
    ...
    colBackground: ColorUtils.mix(Colors?.colors.colLayer2, Colors?.colors.colLayer2Hover, 0.5)
    colBackgroundHover: Colors?.colors.colLayer2Hover ?? "#E5DFED"
    colRipple: Colors?.colors.colLayer2Active ?? "#D6CEE2"
