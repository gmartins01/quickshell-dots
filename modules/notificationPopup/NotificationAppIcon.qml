...
Rectangle { // App icon
    ...
    color: Colors.colors.colSecondaryContainer
    Loader {
        ...
        sourceComponent: MaterialIcon {
            ...
            anchors.fill: parent
            color: (root.urgency == NotificationUrgency.Critical) ? ColorUtils.mix(Colors.m3colors.m3onSecondary, Colors.m3colors.m3onSecondaryContainer, 0.1) : Colors.m3colors.m3onSecondaryContainer
