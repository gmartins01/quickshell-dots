        ...
        delegate: Item {
            ...
            PanelWindow {
                ...
                property bool shouldShowOnThisMonitor: {
                    ...
                    let shouldShow = notificationMonitors.length === 0 || notificationMonitors.includes("*") || notificationMonitors.includes(currentScreenName);
                ...
                Column {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            width: parent.width
                            color: "#FFF"//Theme.backgroundPrimary
                            radius: 20
                            border.color: "#F00FFF"//model.urgency == 2 ? Theme.warning : Theme.outline
                            border.width: 1
                            ...
                            Row {
                                ...
                                Rectangle {
                                    ...
                                    height: 36
                                    radius: width / 2
                                    color: "#FF0000"//Theme.accentPrimary
                                    anchors.verticalCenter: parent.verticalCenter
                                    border.color: Qt.darker("#FF0000"/*Theme.accentPrimary*/, 1.2)
                                    border.width: 1.5
                                    ...
                                    Text {
                                        ...
                                        font.pixelSize: 7//Theme.fontSizeBody
                                        font.bold: true
                                        color: "#00FF00"//Theme.backgroundPrimary
                                    }
                                }
                                ...
                                Column {
                                    ...
                                    Text {
                                        text: model.appName
                                        width: parent.width
                                        color: "#000000"//Theme.textPrimary
                                        // font.family: Theme.fontFamily
                                        font.bold: true
                                        font.pixelSize: 5//Theme.fontSizeSmall
                                    ...
                                    Text {
                                        ...
                                        color: "#cccccc"
                                        // font.family: Theme.fontFamily
                                        font.pixelSize: 10//Theme.fontSizeCaption
                                        wrapMode: Text.Wrap
                                        visible: text !== ""
                                    }
                                }
