...
Item { // Notification item area
    ...
    SequentialAnimation { // Drag finish animation
        ...
        onFinished: () => {
            NotificationService.discardNotification(notificationObject.notificationId);
        }
    }
    ...
    Rectangle { // Background of notification item
        ...
        color: (expanded && !onlyNotification) ? (notificationObject.urgency == NotificationUrgency.Critical) ? ColorUtils.mix(Colors.colors.colSecondaryContainer, Colors.colors.colLayer2, 0.35) : (Colors.colors.colLayer3) : ColorUtils.transparentize(Colors.colors.colLayer3)
        ...
        ColumnLayout { // Content column
            ...
            RowLayout { // Summary row
                ...
                StyledText {
                    ...
                    font.pixelSize: root.fontSize
                    color: Colors.colors.colOnLayer3
                        ...
                        RowLayout {
                            ...
                            NotificationActionButton {
                                ...
                                contentItem: MaterialIcon {
                                    ...
                                    color: (notificationObject.urgency == NotificationUrgency.Critical) ? Colors.m3colors.m3onSurfaceVariant : Colors.m3colors.m3onSurface
                                    text: "close"
                                }
                            }
