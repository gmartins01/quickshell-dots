...
Singleton {
    ...
    property bool popupInhibited: silent//(GlobalStates?.sidebarRightOpen ?? false) || silent TODO: Alterar aqui
            ...
            if (!root.popupInhibited) {
                ...
                if (notification.expireTimeout != 0) {
                    newNotifObject.timer = notifTimerComponent.createObject(root, {
                        ...
                        "interval": notification.expireTimeout < 0 ? 7000 : notification.expireTimeout//notification.expireTimeout < 0 ? (Config?.options.notifications.timeout ?? 7000) : notification.expireTimeout
                    });
                }
            }
